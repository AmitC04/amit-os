  ...
  const skills = [
    ...
    },
    {
      ...
      items: [
        ...
        {name: "EC2", label: "AWS EduSkills"}, 
        {name: "S3", label: "AWS EduSkills"}, 
        {name: "CloudWatch", label: "AWS EduSkills"}
      ]
    },
    {
      domain: "DevOps & Tools",
    ...
    },
    {
      ...
      items: [
        ...
        {name: "Power BI", label: "Projects"}, 
        {name: "Microsoft Excel", label: "Projects"}, 
